...
class fetch_math23k(SplitQuestion):
    ...
    def process_input(self, data_d, data, data_dict, mode='train', single_char=True, dataset='math23k', split_number=True, norm_count=0, used_equ_norm=False):
        Prefix = PREFIX()
        ...
        if equation is not None:
            ...
            data_d["ans"] = answer
            data.append(data_d)
            data_dict[data_d["id"]] = {'question': seg_text_char, 'equation': equation, 'answer': answer}
        return data, trans_equ, data_dict
    ...
    def load_math23k_line_data(self, filename, mode='train', single_char=True, used_equ_norm=False):
        ...
        for i, s in enumerate(f):
            ...
            if i % 7 == 0:  # every 7 line is a json
                ...
                data, trans_equ, data_dict = self.process_input(data_d, data, data_dict, mode, single_char, norm_count=norm_count, used_equ_norm=used_equ_norm)
                if used_equ_norm:
        ...
        return data, equ_ids_dict, data_dict
